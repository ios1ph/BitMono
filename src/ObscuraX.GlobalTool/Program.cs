namespace ObscuraX.GlobalTool;

internal class Program
{
    private static readonly CancellationTokenSource CancellationTokenSource = new();
    private static CancellationToken CancellationToken => CancellationTokenSource.Token;
    private static readonly string ObscuraXFileVersionText =
        $"ObscuraX v{FileVersionInfo.GetVersionInfo(typeof(Program).Assembly.Location).FileVersion}";
    private static readonly string AsciiArt = $"""
                                                   ...
                                                   https://github.com/sunnamed434/ObscuraX
                                                   {ObscuraXFileVersionText}
                                               """;
    ...
    private static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            Console.Title = ObscuraXFileVersionText;
