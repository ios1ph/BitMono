namespace ObscuraX.Utilities.Runtime;
...
public class EnvironmentRuntimeInformation
{
    ...
    /// <summary>
    /// Retrieves detailed information about ObscuraX runtime, like running OS, .NET Framework/.NET Core version, etc.
    /// </summary>
    /// <returns></returns>
    public override string ToString()
    {
        var stringBuilder = new StringBuilder();
        stringBuilder.Append("ObscuraX running on: ");
